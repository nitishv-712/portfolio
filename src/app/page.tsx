    ...
    <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden" }}
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", width: "100%", position: "relative", zIndex: 1 }}>
        <div className="fade-up" style={{ animationDelay: "0.05s", opacity: 0 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 16px", background: "linear-gradient(135deg,rgba(124,58,237,0.1),rgba(37,99,235,0.1))", border: "1px solid rgba(124,58,237,0.2)", borderRadius: 50, marginBottom: 24 }}>
        ...
        <div className="fade-up" style={{ animationDelay: "0.15s", opacity: 0 }}>
          <h1 style={{ fontSize: "clamp(32px, 6vw, 76px)", fontWeight: 800, lineHeight: 1.08, letterSpacing: "-1.5px", marginBottom: 12 }}>
            Hi, I'm <span className="shimmer-text">Nitish Vishwakarma</span>
          </h1>
          <h2 style={{ fontSize: "clamp(20px, 3.5vw, 44px)", fontWeight: 700, letterSpacing: "-0.5px", marginBottom: 20, color: "var(--text-muted)", minHeight: "1.3em" }}>
        ...
        <div className="fade-up" style={{ animationDelay: "0.3s", opacity: 0 }}>
          <p style={{ fontSize: "clamp(15px, 2vw, 18px)", color: "var(--text-muted)", maxWidth: 560, lineHeight: 1.75, marginBottom: 32 }}>
        ...
        <div className="fade-up stats-row" style={{ animationDelay: "0.45s", opacity: 0, borderTop: "1px solid var(--border)", paddingTop: 36 }}>
          {[
            ...
            <div key={s.label} className="stat-card" style={{ minWidth: 130, flex: 1 }}>
...
function About() {
  useReveal();
  return (
    <section id="about" className="section-pad" style={{ background: "var(--bg-subtle)", position: "relative", overflow: "hidden" }}>
      <div className="orb" style={{ width: 400, height: 400, background: "rgba(37,99,235,0.05)", top: "-100px", right: "-100px" }} />
      <div className="grid-2col" style={{ maxWidth: 1100, margin: "0 auto", alignItems: "center", position: "relative", zIndex: 1 }}>
        <div>
          <div className="section-label reveal" style={{ marginBottom: 16 }}>About Me</div>
          <h2 className="reveal reveal-delay-1" style={{ fontSize: "clamp(24px, 3vw, 40px)", fontWeight: 800, marginBottom: 20, lineHeight: 1.2 }}>
            Building things that<br /><span className="gradient-text">live on the web</span>
          </h2>
          <p className="reveal reveal-delay-2" style={{ color: "var(--text-muted)", lineHeight: 1.8, marginBottom: 16, fontSize: "clamp(14px,1.5vw,16px)" }}>
          ...
          <p className="reveal reveal-delay-2" style={{ color: "var(--text-muted)", lineHeight: 1.8, marginBottom: 32, fontSize: "clamp(14px,1.5vw,16px)" }}>
        ...
        <div className="reveal reveal-delay-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          {[
            ...
            <div key={item.label} className="card" style={{ padding: "20px 16px" }}>
              <div style={{ fontSize: 22, marginBottom: 8 }}>{item.icon}</div>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", color: "var(--text-muted)", marginBottom: 4 }}>{item.label}</div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 40, flexWrap: "wrap", gap: 16 }}>
          <div>
            ...
            <h2 className="reveal reveal-delay-1" style={{ fontSize: "clamp(24px, 3vw, 40px)", fontWeight: 800 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(min(300px,100%), 1fr))", gap: 16 }}>
          {PROJECTS.map((p, i) => (
            <div key={p.title} className="card reveal" style={{ padding: "24px 20px", transitionDelay: `${i * 0.08}s` }}>
              <div style={{ width: 38, height: 38, borderRadius: 10, background: `${p.color}18`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
                <div style={{ width: 15, height: 15, borderRadius: 4, background: p.color }} />
              </div>
  ...
  return (
    <section id="skills" className="section-pad" style={{ background: "var(--bg-subtle)", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <h2 className="reveal reveal-delay-1" style={{ fontSize: "clamp(24px, 3vw, 40px)", fontWeight: 800, marginBottom: 40 }}>
          Technologies I <span className="gradient-text">work with</span>
        </h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(min(260px,100%), 1fr))", gap: 16 }}>
          {SKILLS.map((group, i) => (
            <div key={group.group} className="card reveal" style={{ padding: "22px 20px", transitionDelay: `${i * 0.07}s` }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                <div style={{ width: 10, height: 10, borderRadius: "50%", background: group.color, boxShadow: `0 0 8px ${group.color}`, flexShrink: 0 }} />
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", color: group.color }}>{group.group}</div>
              </div>
...
function CTA() {
  return (
    <section className="section-pad" style={{ textAlign: "center", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 560, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <h2 className="reveal reveal-delay-1" style={{ fontSize: "clamp(24px, 4vw, 48px)", fontWeight: 800, marginBottom: 16 }}>
        ...
        <div className="reveal reveal-delay-3">
          <a href="/contact" className="btn-primary btn-glow" style={{ fontSize: 15, padding: "14px 32px" }}>Get In Touch →</a>
        </div>
      </div>
    </section>
  );
